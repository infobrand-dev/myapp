...
class PlatformOwnerController extends Controller
{
    ...
    public function storePromo(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'product_lines.*' => ['string', Rule::in(['accounting', 'commerce', 'omnichannel'])],
    ...
    private function featureLabels(): array
    {
        return [
            ...
            PlanFeature::STOREFRONT => 'Storefront',
            PlanFeature::SHIPPING => 'Shipping',
            PlanFeature::FULFILLMENT => 'Fulfillment',
            ...
            PlanFeature::CUSTOM_DOMAINS => 'Custom domains',
        ...
        return [
            'omnichannel_starter' => [
                ...
                'features' => [
                    ...
                    PlanFeature::CUSTOM_DOMAINS => false,
                    'multi_branch' => false,
                    'inventory' => false,
                    'finance' => false,
                    'pos' => false,
