...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        ...
        <div class="text-muted small">Upload file CSV atau XLSX untuk import massal.</div>
    </div>
    <div class="btn-list">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('contacts.import') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-muted small mt-2">Format: <code>.csv</code>, <code>.txt</code>, <code>.xlsx</code>. Maks 10 MB.</div>
                    </div>
    ...
    <div class="col-lg-5">
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-muted small mb-2">Gunakan header template berikut:</div>
                <div class="small">
                ...
                <div class="text-muted small mt-2">Isi <code>company_name</code> untuk kontak individual yang terkait perusahaan.</div>
            </div>
        </div>
    </div>
</div>
