...
class ChartOfAccountProvisioner
{
    public function ensureDefaults(int $tenantId, int $companyId, ?int $userId = null): void
    {
        ...
        $defaults = [
            ...
            ['code' => 'COGS', 'name' => 'Cost of Goods Sold', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 503],
            ['code' => 'PURCHASES', 'name' => 'Purchases / Inventory', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 504],
            ...
            ['code' => 'LANDED_COST', 'name' => 'Landed Cost', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 505],
            ['code' => 'INV_ADJ_LOSS', 'name' => 'Inventory Adjustment Loss', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 506],
