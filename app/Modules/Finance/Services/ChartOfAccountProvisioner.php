...
class ChartOfAccountProvisioner
{
    public function ensureDefaults(int $tenantId, int $companyId, ?int $userId = null): void
    {
        ...
        $defaults = [
            ...
            ['code' => 'INVENTORY_IN_TRANSIT', 'name' => 'Inventory In Transit', 'account_type' => ChartOfAccount::TYPE_ASSET, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_BALANCE_SHEET, 'is_postable' => true, 'parent_code' => 'ASSET', 'sort_order' => 106],
            ...
            ['code' => 'PPH_PAYABLE', 'name' => 'PPh Withholding Payable', 'account_type' => ChartOfAccount::TYPE_LIABILITY, 'normal_balance' => ChartOfAccount::NORMAL_CREDIT, 'report_section' => ChartOfAccount::SECTION_BALANCE_SHEET, 'is_postable' => true, 'parent_code' => 'LIAB', 'sort_order' => 203],
            ...
            ['code' => 'PPH_RECEIVABLE', 'name' => 'PPh Withholding Receivable', 'account_type' => ChartOfAccount::TYPE_ASSET, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_BALANCE_SHEET, 'is_postable' => true, 'parent_code' => 'ASSET', 'sort_order' => 107],
            ['code' => 'TAX_ADJUSTMENT', 'name' => 'Tax Adjustment Clearing', 'account_type' => ChartOfAccount::TYPE_ASSET, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_BALANCE_SHEET, 'is_postable' => true, 'parent_code' => 'ASSET', 'sort_order' => 108],
            ...
            ['code' => 'OPENING_BAL_EQUITY', 'name' => 'Opening Balance Equity', 'account_type' => ChartOfAccount::TYPE_EQUITY, 'normal_balance' => ChartOfAccount::NORMAL_CREDIT, 'report_section' => ChartOfAccount::SECTION_BALANCE_SHEET, 'is_postable' => true, 'parent_code' => 'EQ', 'sort_order' => 303],
            ...
            ['code' => 'INV_ADJ_GAIN', 'name' => 'Inventory Adjustment Gain', 'account_type' => ChartOfAccount::TYPE_REVENUE, 'normal_balance' => ChartOfAccount::NORMAL_CREDIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'REV', 'sort_order' => 403],
            ['code' => 'AP_WRITE_OFF', 'name' => 'Accounts Payable Write-off', 'account_type' => ChartOfAccount::TYPE_REVENUE, 'normal_balance' => ChartOfAccount::NORMAL_CREDIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'REV', 'sort_order' => 404],
            ...
            ['code' => 'SALES_RETURNS', 'name' => 'Sales Return / Credit Memo', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 502],
            ['code' => 'SALES_REFUND', 'name' => 'Sales Refund', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 503],
            ['code' => 'COGS', 'name' => 'Cost of Goods Sold', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 504],
            ['code' => 'PURCHASES', 'name' => 'Purchases / Inventory', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 505],
            ['code' => 'LANDED_COST', 'name' => 'Landed Cost', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 506],
            ['code' => 'INV_ADJ_LOSS', 'name' => 'Inventory Adjustment Loss', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 507],
            ['code' => 'AR_WRITE_OFF', 'name' => 'Accounts Receivable Write-off', 'account_type' => ChartOfAccount::TYPE_EXPENSE, 'normal_balance' => ChartOfAccount::NORMAL_DEBIT, 'report_section' => ChartOfAccount::SECTION_PROFIT_LOSS, 'is_postable' => true, 'parent_code' => 'EXP', 'sort_order' => 508],
        ];
        ...
        foreach ($defaults as $row) {
            ...
            $created[$row['code']] = ChartOfAccount::query()->create([
                ...
                'is_postable' => $row['is_postable'] ? 'true' : 'false',
                'is_active' => 'true',
