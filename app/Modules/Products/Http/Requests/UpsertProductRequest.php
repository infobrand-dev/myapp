...
class UpsertProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'shipping_length_cm' => ['nullable', 'numeric', 'min:0.1', 'max:10000'],
            'shipping_width_cm' => ['nullable', 'numeric', 'min:0.1', 'max:10000'],
            'shipping_height_cm' => ['nullable', 'numeric', 'min:0.1', 'max:10000'],
            ...
            'public_offer_visibility' => ['nullable', Rule::in(['catalog', 'featured', 'direct', 'private'])],
            'public_offer_headline' => ['nullable', 'string', 'max:255'],
            'public_offer_subtitle' => ['nullable', 'string', 'max:500'],
            'public_offer_delivery_type' => ['nullable', Rule::in(['physical', 'download', 'external_link', 'manual_fulfillment', 'service', 'consultation'])],
            'public_offer_delivery_instructions' => ['nullable', 'string', 'max:2000'],
            'public_offer_download_url' => ['nullable', 'url', 'max:500'],
            'public_offer_external_url' => ['nullable', 'url', 'max:500'],
            'public_offer_slot_note' => ['nullable', 'string', 'max:500'],
            'public_offer_cta_label' => ['nullable', 'string', 'max:80'],
            'public_offer_featured' => ['nullable', 'boolean'],
            'affiliate_enabled' => ['nullable', 'boolean'],
            'affiliate_commission_type' => ['nullable', Rule::in(['percentage', 'flat'])],
            'affiliate_commission_rate' => ['nullable', 'numeric', 'min:0'],
            'affiliate_allow_landing_copy' => ['nullable', 'boolean'],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $payload = [
            ...
            'shipping_weight_grams' => $this->filled('shipping_weight_grams') ? (int) $this->input('shipping_weight_grams') : null,
            'shipping_length_cm' => $this->filled('shipping_length_cm') ? (float) $this->input('shipping_length_cm') : null,
            'shipping_width_cm' => $this->filled('shipping_width_cm') ? (float) $this->input('shipping_width_cm') : null,
            'shipping_height_cm' => $this->filled('shipping_height_cm') ? (float) $this->input('shipping_height_cm') : null,
            'public_offer_featured' => $this->boolean('public_offer_featured'),
            'affiliate_enabled' => $this->boolean('affiliate_enabled'),
            'affiliate_allow_landing_copy' => $this->boolean('affiliate_allow_landing_copy'),
