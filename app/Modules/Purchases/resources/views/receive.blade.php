...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">Receive Goods {{ $purchase->purchase_number }}</h2>
            <p class="text-muted mb-0">Catat penerimaan barang dari supplier.</p>
        </div>
        <div class="col-auto">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-package me-1"></i>Post Receipt
                    </button>
                </div>
            </div>
        </div>
