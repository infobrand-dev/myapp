...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Grand Total</div><div class="fs-2 fw-bold">{{ $money->format((float) $summary['grand_total'], $currency) }}</div></div></div></div>
    ...
    <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Balance Due</div><div class="fs-2 fw-bold">{{ $money->format((float) $summary['balance_due_total'], $currency) }}</div></div></div></div>
</div>
