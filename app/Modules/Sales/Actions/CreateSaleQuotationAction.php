...
class CreateSaleQuotationAction
{
    ...
    public function execute(array $data, ?User $actor = null): SaleQuotation
    {
        return DB::transaction(function () use ($data, $actor) {
            ...
            $quotation = SaleQuotation::query()->create([
                ...
                'quotation_number' => $this->numberService->generate(
                    !empty($data['quotation_date']) ? new \DateTimeImmutable((string) $data['quotation_date']) : null
                ),
