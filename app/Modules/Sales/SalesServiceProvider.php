...
class SalesServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(SaleReceivableDisputeNumberService::class);
        ...
        $this->app->singleton(CreateSaleReceivableDisputeAction::class);
        ...
        $this->app->singleton(ResolveSaleReceivableDisputeAction::class);
