                        ...
                        <tr>
                            ...
                            <td class="text-end align-middle">
                                <div class="table-actions">
                                    ...
                                    <form class="d-inline-block m-0" method="POST" action="{{ route('tasktemplates.destroy', $template) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-icon btn-outline-danger" title="Delete" data-confirm="Hapus template ini?">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                <path d="M4 7h16" />
                                                <path d="M10 11v6" />
