...
use App\Services\NullCommerceDraftFinalizer;
use App\Services\NullCommercePendingOrderExpirer;
use App\Services\NullFileMalwareScanner;
use App\Services\NullFileMediaProcessor;
use App\Services\NullMidtransCheckoutGateway;
use App\Services\NullPublicStorefrontResponder;
use App\Services\NullRajaOngkirShippingGateway;
use App\Services\NullTripayCheckoutGateway;
use App\Services\NullXenditCheckoutGateway;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(PublicStorefrontResponder::class, NullPublicStorefrontResponder::class);
        $this->app->bind(CommercePendingOrderExpirer::class, NullCommercePendingOrderExpirer::class);
        $this->app->bind(CommerceDraftFinalizer::class, NullCommerceDraftFinalizer::class);
        $this->app->bind(MidtransCheckoutGateway::class, NullMidtransCheckoutGateway::class);
        $this->app->bind(TripayCheckoutGateway::class, NullTripayCheckoutGateway::class);
        $this->app->bind(XenditCheckoutGateway::class, NullXenditCheckoutGateway::class);
        $this->app->bind(BiteshipShippingGateway::class, NullBiteshipShippingGateway::class);
