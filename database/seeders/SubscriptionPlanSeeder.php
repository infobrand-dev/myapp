    ...
    private array $plans = [
        [
            ...
            'limits' => [
                ...
                PlanLimit::USERS => 3,
                PlanLimit::TOTAL_STORAGE_BYTES => 536870912,
        ...
        [
            ...
            'features' => [
                PlanFeature::MULTI_COMPANY => false,
                PlanFeature::CRM => true,
                PlanFeature::CRM_EXPORTS => false,
                PlanFeature::CRM_MANAGER_VISIBILITY => false,
                PlanFeature::CRM_AUTOMATION => false,
            ],
            'limits' => [
                PlanLimit::COMPANIES => 1,
                PlanLimit::BRANCHES => 1,
                ...
                PlanLimit::TOTAL_STORAGE_BYTES => 1073741824,
                PlanLimit::CONTACTS => 2000,
                PlanLimit::CRM_PIPELINES => 1,
                PlanLimit::CRM_CUSTOM_STAGES => 6,
                PlanLimit::CRM_ACTIVE_DEALS => 250,
            ],
            'meta' => [
                'price' => 149000,
                'currency' => 'IDR',
        ...
        [
            ...
            'features' => [
                PlanFeature::MULTI_COMPANY => true,
                PlanFeature::CRM => true,
                PlanFeature::CRM_EXPORTS => true,
                PlanFeature::CRM_MANAGER_VISIBILITY => true,
                PlanFeature::CRM_AUTOMATION => false,
            ],
            'limits' => [
                PlanLimit::COMPANIES => 1,
                ...
                PlanLimit::TOTAL_STORAGE_BYTES => 5368709120,
                PlanLimit::CONTACTS => 10000,
                PlanLimit::CRM_PIPELINES => 5,
                PlanLimit::CRM_CUSTOM_STAGES => 20,
                PlanLimit::CRM_ACTIVE_DEALS => 2500,
            ],
            'meta' => [
                'price' => 299000,
                'currency' => 'IDR',
        ...
        [
            ...
            'features' => [
                ...
                PlanFeature::CRM_EXPORTS => true,
                PlanFeature::CRM_MANAGER_VISIBILITY => true,
                PlanFeature::CRM_AUTOMATION => true,
            ],
            'limits' => [
                PlanLimit::COMPANIES => 3,
                PlanLimit::BRANCHES => 10,
                ...
                PlanLimit::TOTAL_STORAGE_BYTES => 21474836480,
                PlanLimit::CONTACTS => 50000,
                PlanLimit::CRM_PIPELINES => 15,
                PlanLimit::CRM_CUSTOM_STAGES => 50,
                PlanLimit::CRM_ACTIVE_DEALS => 10000,
            ],
            'meta' => [
                'price' => 599000,
                'currency' => 'IDR',
        ...
        [
            ...
            'limits' => [
                ...
                PlanLimit::BRANCHES => -1,
                PlanLimit::USERS => -1,
                PlanLimit::TOTAL_STORAGE_BYTES => -1,
