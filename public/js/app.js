...
/* harmony import */ var _tabler_core_dist_js_tabler_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @tabler/core/dist/js/tabler.min.js */ "./node_modules/@tabler/core/dist/js/tabler.min.js");
/* harmony import */ var _tabler_core_dist_js_tabler_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_tabler_core_dist_js_tabler_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
var applyTheme = function applyTheme(mode, color) {
  var root = document.documentElement;
  root.setAttribute('data-bs-theme', mode || 'light');
  if (color) {
    var _color$match$map, _color$match;
    root.style.setProperty('--tblr-primary', color);
    var rgb = (_color$match$map = (_color$match = color.match(/[0-9a-f]{2}/gi)) === null || _color$match === void 0 ? void 0 : _color$match.map(function (h) {
      return parseInt(h, 16);
    })) !== null && _color$match$map !== void 0 ? _color$match$map : [32, 107, 196];
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('[data-theme-mode]').forEach(function (btn) {
    btn.addEventListener('click', function () {
      return applyTheme(btn.dataset.themeMode, localStorage.getItem('theme-color'));
    });
  });
  document.querySelectorAll('[data-theme-color]').forEach(function (btn) {
    btn.addEventListener('click', function () {
      return applyTheme(localStorage.getItem('theme-mode') || 'light', btn.dataset.themeColor);
    });
  });
});
...
var PusherLib = null;
try {
  EchoLib = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'laravel-echo'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
  PusherLib = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'pusher-js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
} catch (error) {
  EchoLib = null;
  PusherLib = null;
}
