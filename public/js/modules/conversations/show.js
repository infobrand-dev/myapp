...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var formatMessageStatusLabel = function formatMessageStatusLabel(status) {
  ...
  var buildMessageNode = function buildMessageNode(msg) {
    ...
    var state = "".concat(msg.direction === 'out' ? 'Keluar' : 'Masuk').concat(msg.status ? ' | ' + (msg.status_label || formatMessageStatusLabel(msg.status)) : '');
