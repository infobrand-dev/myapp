...
<head>
    ...
    <title>{{ config('app.name') }} | Program Affiliate</title>
    <meta name="description" content="Aturan, komisi, masa atribusi, dan jadwal payout program affiliate {{ config('app.name') }}.">
            ...
            <div class="container py-3 d-flex align-items-center justify-content-between gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="text-muted small">Program Affiliate</div>
                    </div>
                </div>
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('landing') }}" class="btn btn-outline-dark">Kembali ke Landing</a>
                    <a href="{{ route('onboarding.create') }}" class="btn btn-dark">Mulai Jualan</a>
                </div>
            </div>
        </header>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7">
                            <div class="landing-badge mb-4">
                                ...
                                Aturan affiliate yang transparan dan bisa diverifikasi
                            </div>
                            <h1 class="landing-headline mb-4">
                                Program affiliate untuk partner yang ingin ikut bertumbuh bersama <span>{{ config('app.name') }}</span>.
                            </h1>
                            <p class="landing-subtext mb-4">
                                Halaman ini menjelaskan aturan komisi, atribusi referral, payout, dan kondisi referral yang dihitung. Isinya mengikuti setting aktif platform, bukan brosur statis.
                            </p>
                        ...
                        <div class="col-lg-5">
                            <div class="landing-panel p-4 p-lg-5">
                                <div class="text-uppercase text-muted small fw-bold mb-2">Ringkasan Program</div>
                                <div class="landing-highlight-list small text-muted">
                                    ...
                                    <div>Payout day target: <strong>Tanggal {{ $policy['payout_day'] }}</strong></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="landing-result-card p-4">
                                ...
                                <h3 class="h4">Berapa komisi yang didapat?</h3>
                        ...
                        <div class="col-lg-4">
                            <div class="landing-result-card p-4">
                                ...
                                <h3 class="h4">Berapa lama referral dikunci?</h3>
                        ...
                        <div class="col-lg-6">
                            <div class="landing-panel p-4 h-100">
                                ...
                                <div class="landing-highlight-list text-muted">
                                    ...
                                    <div class="mb-2">Sale tercatat ke affiliate yang masih aktif.</div>
                                    <div class="mb-2">
                        ...
                        <div class="col-lg-6">
                            <div class="landing-panel p-4 h-100">
                                ...
                                <div class="landing-highlight-list text-muted">
                                    ...
                                    @if($policy['first_purchase_only'])
                                        <div class="mb-2">Perpanjangan langganan / renewal tenant yang sama.</div>
                    ...
                    <div class="landing-panel p-4 p-lg-5 rounded-4">
                        <div class="row g-4">
                            <div class="col-lg-6">
                                ...
                                <h2 class="landing-section-title mb-3">Agar transparan, komisi berjalan lewat status.</h2>
                                <div class="landing-highlight-list text-muted">
                            ...
                            <div class="col-lg-6">
                                <div class="text-uppercase text-muted small fw-bold mb-2">Jadwal Payout</div>
                                <h2 class="landing-section-title mb-3">Operasional payout</h2>
                                <div class="landing-highlight-list text-muted">
                                    ...
                                    <div>Untuk pertanyaan operasional, gunakan email: <strong>{{ config('mail.from.address', 'hello@' . config('multitenancy.saas_domain', 'app.com')) }}</strong></div>
                                </div>
                            </div>
                        </div>
                    </div>
