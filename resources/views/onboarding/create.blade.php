    ...
    <x-auth-card>
        @php
            ...
            $lineIntro = $isAccounting
                ? 'Pilih paket, buat workspace, lalu lanjutkan ke pembayaran untuk mengaktifkan workflow transaksi yang Anda butuhkan.'
                : 'Pilih paket, buat workspace, lalu lanjutkan ke pembayaran untuk mengaktifkan modul yang Anda beli.';
        ...
        <div class="alert alert-light border py-3 px-3 mb-4">
        ...
        <form method="POST" action="{{ route('onboarding.store') }}">
            ...
            <div class="mb-4" x-data="{ selected: {{ $selectedPlanId }}, paymentMethod: '{{ $defaultPaymentMethod }}', signupMode: '{{ $defaultSignupMode }}' }">
                @php
                            ...
                            @foreach ($intervalPlans as $plan)
                                ...
                                <div class="col-12">
                                    <label
                                        ...
                                        :class="{
                                            'border-primary shadow-sm': selected == {{ $plan->id }},
                                            'opacity-50': signupMode === 'trial' && '{{ $plan->billing_interval }}' !== 'monthly'
                                        }"
                ...
                <div class="mb-4" x-show="signupMode === 'paid'">
