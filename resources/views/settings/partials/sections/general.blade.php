<div class="row g-3">
    <div class="col-lg-7">
        <div class="card h-100">
            <div class="card-header">
                <h3 class="card-title mb-0">Workspace Profile</h3>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="text-secondary small text-uppercase fw-bold">Tenant name</div>
                        <div class="fw-semibold mt-1">{{ optional($tenant)->name ?? 'Default tenant' }}</div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-secondary small text-uppercase fw-bold">Tenant slug</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-1">
                            <span class="badge bg-{{ (optional($tenant)->is_active ?? true) ? 'success' : 'danger' }}-lt text-{{ (optional($tenant)->is_active ?? true) ? 'success' : 'danger' }}">
                                {{ (optional($tenant)->is_active ?? true) ? 'Active' : 'Inactive' }}
                            </span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-secondary small text-uppercase fw-bold">Current plan</div>
                        <div class="fw-semibold mt-1">{{ optional($plan)->name ?? 'No plan binding' }}</div>
                    </div>
                </div>
    ...
    <div class="col-lg-5">
        <div class="card h-100">
            <div class="card-header">
                <h3 class="card-title mb-0">Scope Summary</h3>
            </div>
